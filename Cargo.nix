    ...
    crates = {
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "5139dd2d37cae674912c169b4b20a03aecc08484";
          sha256 = "07id8l8m9bpqqcwkhjk0s9qarmdhapwrv6br0dzfkm2jqj38fr55";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "rt" "rt-multi-thread" ];
      };
      "toml" = rec {
        crateName = "toml";
        version = "0.8.23";
